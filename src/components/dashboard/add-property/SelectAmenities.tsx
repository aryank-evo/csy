...
const SelectAmenities = ({ onSelectAmenities }: { onSelectAmenities?: (amenities: string) => void }) => {
   ...
   const handleAmenityChange = (amenity: string) => {
      ...
      // Send the comma-separated string to the parent component
      if (onSelectAmenities) {
         onSelectAmenities(newSelected.join(', '));
      }
   };
