...
const CommonBanner = ({ property, style_3 }: any) => {
   const { title, address, price, propertyType } = property || {};
   
   return (
      <div className="row">
         <div className="col-lg-6">
            <h3 className="property-titlee">{title || "Property Details"}</h3>
            <div className="d-flex flex-wrap mt-10">
               ...
               <div className="address mt-15"><i className="bi bi-geo-alt"></i> {address || "Location not available"}
               </div>
            </div>
         </div>
         <div className="col-lg-6 text-lg-end">
            <div className="d-inline-block md-mt-40">
               <div className="price color-dark fw-500">Price: ₹{price?.toLocaleString() || "0"}</div>
