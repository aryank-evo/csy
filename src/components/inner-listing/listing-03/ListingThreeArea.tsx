"use client"
import DropdownLease from "@/components/search-dropdown/inner-dropdown/DropdownLease";
                     ...
                     <div className="row gx-xxl-5">
                        {currentItems.map((item: any) => (
                           <div key={item.id} className="col-md-6 d-flex mb-50 wow fadeInUp" data-wow-delay={item.data_delay_time}>
                              <div className="listing-card-one border-25 h-100 w-100 listingThree">
                                 ...
                                 <div className="property-info p-25">
                                    <Link href={`/lease/${item.id}`} className="title tran3s">{item.title}</Link>
                                    ...
                                    <div className="pl-footer top-border d-flex align-items-center justify-content-between">
                                       ...
                                       <Link href={`/lease/${item.id}`} className="btn-four rounded-circle"><i className="bi bi-arrow-up-right"></i></Link>
                                    </div>
                                 </div>
                              </div>
                           </div>
