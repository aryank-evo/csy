        ...
        <div className="container">
          <div className="bg-white border-20 p-40 lg-p-25">
            ...
            <p className="mb-25">
              ...
              discovery platform that enables users to buy, rent, lease, and
              find paying guest (PG) accommodations. This Privacy Policy
            ...
            <ul className="mb-25">
              <li>
                ...
                email address, user type (Buyer / Agent / Consultant), property
                preferences, and any details submitted via forms.
              </li>
              <li>
                <strong>Property Listing Data:</strong> Information submitted by
                owners, agents, or consultants when listing properties.
              </li>
              <li>
                <strong>Location Data:</strong> Approximate location information
                when using map-based search features.
              </li>
              <li>
            ...
            <p className="mb-25">
              ...
              information before full access is granted. This helps us ensure
              genuine inquiries and improve service quality. We may use secure
              session storage or cookies to remember previously submitted leads
              for a limited duration.
            </p>

            <h4 className="mb-15">4. Cookies & Local Storage</h4>
            <p className="mb-25">We use cookies and browser storage to:</p>
            <ul className="mb-25">
            ...
            <ul className="mb-25">
              <li>
                With property owners or authorized agents for inquiry purposes
              </li>
              <li>
                With trusted service providers (hosting, analytics, cloud
                storage)
              </li>
            ...
            <p className="mb-25">
              Our platform integrates Google Maps and related APIs for map
              display and location-based search. Use of these services is
              subject to Google’s own privacy policies and terms.
            </p>
            ...
            <p className="mb-25">
              ...
              data by contacting us through the contact information provided on
              our website.
            </p>
            ...
            <p className="mb-25">
              ...
              effective once posted on this page with a revised “Last updated”
              date.
            </p>
            ...
            <p className="mb-0">
              ...
              through the official contact details listed on our website.
            </p>
          </div>
        </div>
      </main>
