...
router.post('/', PropertyController_1.createProperty); // Create property listing without auth
...
router.put('/:id', PropertyController_1.updateProperty); // Update property details
