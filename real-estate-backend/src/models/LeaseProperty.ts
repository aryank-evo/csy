...
interface LeasePropertyAttributes {
  id: number;
  title: string;
  description: string;
  price: number;
...
export interface LeasePropertyCreationAttributes extends Optional<LeasePropertyAttributes, 'id'> {}

export class LeaseProperty extends Model<LeasePropertyAttributes, LeasePropertyCreationAttributes> implements LeasePropertyAttributes {
  public id!: number;
  public title!: string;
